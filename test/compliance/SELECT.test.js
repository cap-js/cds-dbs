...
describe('SELECT', () => {
  ...
  describe('columns', () => {
    ...
    test('strings fields can be converted to data types', async () => {
      ...
      assert.strictEqual(Number(res[0].integer16Field), 9, 'Ensure that the Int16 conversion happens')
      assert.strictEqual(Number(res[0].integer32Field), 10, 'Ensure that the Int32 conversion happens')
