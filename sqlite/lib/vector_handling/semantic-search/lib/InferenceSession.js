...
class InferenceSession {
        ...
        for (const key in results) {
            if (Object.hasOwnProperty.call(results, key)) {
                ...
                if (result instanceof ort.Tensor) {
                    ...
                    returnValue[key] = new ort.Tensor(result.type, result.data, result.dims);
                }
            }
        }
        return returnValue;
    ...
    static async create(arg0) {
        ...
        if (arg0 instanceof Uint8Array) {
            ...
            throw Error('Argument is not supported. Check original InferenceSession implementation if this adjustment needs to be adopted')
        }
