...
describe('insert from select', () => {
  ...
  test('insert result works for single entries', async () => {
    ...
    assert.strictEqual(insertResult.affected, 1, 'One row should have been inserted')
  ...
  test('insert result works for batch entries', async () => {
    ...
    assert.strictEqual(insertResult.affected, 10, 'One row should have been inserted')
