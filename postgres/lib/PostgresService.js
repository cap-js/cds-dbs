...
`
  ...
  static CQN2SQL = class CQN2Postgres extends SQLService.CQN2SQL {
    ...
    static OutputConverters = {
      ...
      Date: e => `to_char(${e}::timestamp, 'YYYY-MM-DD')`,
      Time: e => `to_timestamp(${e}::text, 'HH24:MI:SS')::TIME`,
      DateTime: e => `to_char(${e}::timestamp, 'YYYY-MM-DD"T"HH24:MI:SS"Z"')`,
      Timestamp: e => `to_char(${e}::timestamp, 'YYYY-MM-DD"T"HH24:MI:SS.FF3"Z"')`,
