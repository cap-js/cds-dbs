...
`
  ...
  static CQN2SQL = class CQN2Postgres extends SQLService.CQN2SQL {
    ...
    static OutputConverters = {
      ...
      Date: e => `to_date(${e}::text, 'YYYY-MM-DD')`,
      Time: e => `to_timestamp(${e}::text, 'HH24:MI:SS')::TIME`,
      DateTime: e => `to_timestamp(${e}::text, 'YYYY-MM-DD"T"HH24:MI:SS"Z"')::timestamp`,
      Timestamp: e => `to_timestamp(${e}::text, 'YYYY-MM-DD"T"HH24:MI:SS.US"Z"')::timestamp`,
